...
_STRINGS = {
    'zh': {
        ...
        'rules_whitelist_section': '精确账号/正则脱敏名单 (直接涂黑匹配的值)',
        'rules_whitelist_mode_tip': '注意：添加正则表达式请勾选对应选项',
        'rules_bank_label': '银行规则视图:',
        'rules_replacement_label': '替换字符:',
        'rules_save_btn': '保存全部规则',
        'rules_test_btn': '测试规则',
        'col_id': 'ID',
        'col_name': '规则名称(仅备注)',
        'col_regex': '正则表达式',
    ...
    'en': {
        ...
        'rules_whitelist_section': 'Exact / Regex Account Redaction',
        'rules_whitelist_mode_tip': 'Note: Check "Is Regex" for pattern matching',
        'rules_bank_label': 'Bank Rule View:',
        'rules_replacement_label': 'Replacement:',
        'rules_save_btn': 'Save All Rules',
        ...
        'col_account': 'Account / Regex / Word',
        'col_note': 'Note',
        'btn_add': 'Add',
        'btn_edit': 'Edit',
        'btn_delete': 'Delete',
