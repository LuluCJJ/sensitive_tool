...
_STRINGS = {
    'zh': {
        ...
        'rules_whitelist_section': '精确账号脱敏名单',
        'rules_whitelist_mode_tip': '启用白名单精确脱敏模式（开启后将关闭正则匹配，只脱敏下方列表中的账号）',
        'rules_bank_label': '银行规则视图:',
        ...
        'dialog_add_account': '添加账号',
        'dialog_edit_account': '编辑账号',
        'dialog_test': '规则测试',
    ...
    'en': {
        ...
        'rules_whitelist_section': 'Exact Account Whitelist',
        'rules_whitelist_mode_tip': 'Enable whitelist mode (disables regex, only redacts accounts listed below)',
        'rules_bank_label': 'Bank Rule View:',
